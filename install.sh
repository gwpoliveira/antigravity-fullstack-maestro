...
cat << 'EOF' > "$PLUGIN_DIR/plugin.json"
{
  ...
  "description": "Ecossistema global do Agente Regente MAESTRO e 8 Subagentes Especialistas para Full Stack Python Django, Next.js, MySQL, SaaS, E-commerce, Apps, Jogos, VPS sem Docker, Testes e Selo de Segurança."
}
EOF
